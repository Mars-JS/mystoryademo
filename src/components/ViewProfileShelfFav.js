...
class ViewProfileShelfFav extends Component {
                        ...
                        <div className="container">
                            <div className="row titleRow"><a href='/viewprofile' className='viewAll'>View all ></a>
                                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div className="font3 shelfTitle">Rihanna's Favorite Stories</div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <Carousel.Item>
                                        <div className="container">
                                            <div className="row ">
                                                ...
                                                <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                    <div className='containerBook'>
                                                        <img alt="" className="shelfBook2 img-responsive" src={require("../img/cont4.jpg")} />
                                                        <Link to="/books/7">
                                                            <div className='overlay'>
                                                                <div className="bookTitle">book Title</div>
...
export default ViewProfileShelfFav;