        ...
        return (
            <div className='container'>
                <div className="container-fluid center-block" style={{ marginTop: '10%', marginBottom: '10%' }}>
                    ...
                    <div className="row" >
                        <div className="col-sm-12 col-md-12 col-lg-12">
                            <Carousel className="carousel" style={{ width: "130%", height: "130%", marginTop: '2%', marginBottom: '2%' }} >
                                            ...
                                            <div className="col-sm-6 col-md-6 col-lg-6">
                                                ...
                                                <div className='row'>
                                                    <div className="col-sm-12 col-md-12 col-lg-12">
                                                            ...
                                                            <iframe id="videoPlayer" width="480px" height="272px" src="https://www.youtube.com/embed/0RyInjfgNc4" className="center-block" title="rihanna"/>
                                                    ...
                                                    <div className="container">
                                                        <div className='row' style={{ marginBottom: '12px' }}>
                                                            <div className='col-sm-3 col-md-3 col-lg-3'>
                                                                <img alt=""  className="img-responsive img-rounded" src={require("../img/rihannaPageParis.jpg")} />
                                                            </div>
                                                    ...
                                                    <div className="container">
                                                        <div className='row'>
                                                            <div className='col-sm-4 col-md-6 col-lg-8'>
                                                                <img alt=""  className="img-responsive img-rounded" src={require("../img/rihannaPageBridge.jpg")} />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-sm-6 col-md-6 col-lg-6">
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-sm-4 col-md-4 col-lg-4'>
                                                            <img alt=""  className="img-responsive img-rounded" src={require("../img/rihannaPage4.jpg")} />
                                                        </div>
                                                        <div className='col-sm-4 col-md-4 col-lg-4'>
                                                        </div>
                                                    </div>
