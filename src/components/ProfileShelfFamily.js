...
class ProfileShelfFamily extends Component {
                        ...
                        <div className="container">
                            <div className="row titleRow"><a href='/viewprofile' className='viewAll'>View all ></a>
                                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div className="font3 shelfTitle">My Family Stories</div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="row ">
                                                <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                    <div className='containerBook'>
                                                        <img alt="" className="shelfBook2 img-responsive" src={require("../img/fam1.jpg")} />
                                                        <Link to="/books/7">
                                                ...
                                                <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                    <div className='containerBook'>
                                                        <img alt="" className="shelfBook2 img-responsive" src={require("../img/fam2.jpg")} />
                                                        <Link to="/books/7">
                                                            <div className='overlay'>
                                                                <div className="bookTitle">book Title</div>
                                                ...
                                                <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                    <div className='containerBook'>
                                                        <img alt="" className="shelfBook2 img-responsive" src={require("../img/fam3.jpg")} />
                                                        <Link to="/books/7">
                                                            <div className='overlay'>
                                                                <div className="bookTitle">book Title</div>
                                                ...
                                                <div className="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                                    <div className='containerBook'>
                                                        <img alt="" className="shelfBook2 img-responsive" src={require("../img/fam4.jpg")} />
                                                        <Link to="/books/7">
                                                            <div className='overlay'>
                                                                <div className="bookTitle">book Title</div>
                                                                <div className="bookViews"><span className='glyphicon glyphicon-sunglasses' /> 1,111</div>
...
export default ProfileShelfFamily;